...
function handle(e) {
	...
	if (key ==13 && go.value !== null){
	    eel.name_entry(go.value);
//	    document.getElementById("vName").style.display="none";
//	    document.getElementById("vTextID").style.display="none";
//	    document.getElementById("vChatID").style.display="block";
//		document.getElementById("vHumanID").style.display="block";
//		document.getElementById("vChatID").style.marginTop = "auto";
		
//		document.getElementById("vRegisterPageID").style.display="block";
	}
}
...
setTimeout(function vTout(){vClix.disabled = false;vSpeed = 11000;vPhase = 1;vText.style.backgroundImage = 'linear-gradient('
        + 'to top' + ', ' + '#248f24 0%' + ', ' + '#33cc33 100%' + ')';vText.innerHTML = 'Phase I - Complete';},7000); 
