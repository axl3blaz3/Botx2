...
function efc(){
	...
	document.getElementById("fire").innerHTML="Lisa AI"
	setTimeout(doSomething, 5000);

    function doSomething() {
    document.getElementById("fire").innerHTML="In Works"
	
    }
	
	function doSomething() {
    document.getElementById("fire").innerHTML="Voice Recognition"
	
    }
	
	function doSomething() {
    document.getElementById("fire").innerHTML="Personal Assistant"
...
function passive1(){
    ...
    for (var i = 0; i < points; i++){
        ...
        swingpoints.push({ 
            ...
            y: ptY,
            radian: radian,
            range: vEffect, //random(rangeMin, rangeMax),
            phase: 0 
        });
